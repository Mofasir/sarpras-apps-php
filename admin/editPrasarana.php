...
$prasarana = query("SELECT * FROM data_prasarana WHERE id_prasarana = '$id_prasarana'")[0];

if( isset($_POST["simpan"]) ) {
    if( editPrasarana($_POST) > 0 ) {
        echo "<script>
...
<body>
    ...
    <main>
        ...
        <h1 class="add" >Edit Prasarana</h1>
