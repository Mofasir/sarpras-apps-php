...
// konfigurasi
$jmlhDataperHal = 6;
$jmlhData = count(query("SELECT * FROM request"));
$jmlhHal = ceil($jmlhData / $jmlhDataperHal);
$halAktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awalData = ( $jmlhDataperHal * $halAktif ) - $jmlhDataperHal;

$request = query("SELECT * FROM request LIMIT $awalData, $jmlhDataperHal");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <main>
        ...
        <button class="buttonprint"><a href="cetakPermintaan.php" target="blank">Cetak Laporan</a></button>
        <table>
            <tr>
                <th>No.</th>
                <th>Nama</th>
